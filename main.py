...
# ------------------------------------
# Part 6: LLM & Prompt Configuration
# ------------------------------------
# Replace the existing system_prompt and prompt sections with this updated version:

# ------------------------------------
# Part 6: LLM & Prompt Configuration (UPDATED)
# ------------------------------------
...
# ------------------------------------
# Part 7: Integrated Chat Function with Feedback
# ------------------------------------
...
# ------------------------------------
# Part 8: Main Conversation Loop
# ------------------------------------
if __name__ == "__main__":
    print("🎓 EduCounselor is ready to help with parent queries!")
    print("This bot uses your documents and AI to answer parent FAQs.")
    ...
    while True:
        ...
        if feedback not in ["yes", "no"]:
            ...
            with open("feedback_log.json", "a") as f:
                json.dump({"query": user_input, "response": response, "feedback": feedback}, f)
                f.write("\n")
